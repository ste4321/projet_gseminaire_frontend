...
const Nav = () => {
    ...
    return (
      ...
      <section id="gtco-hero" className="gtco-cover"  style={{ backgroundImage: `url(/images/les_scolastiques.jpg)` }}   data-section="home"  data-stellar-background-ratio="0.5">
          ...
          <div className="col-md-12 col-md-offset-0 text-center">
            <div className="display-t">
              <div className="display-tc">
                <h1 className="animate-box" data-animate-effect="fadeIn">« Soyez toujours prêts à justifier votre espérance » (1Pi 3, 15).</h1>
              </div>
            </div>
          </div>
        </div>
